...
To finalize the set-up for publishing to PyPI, see [here](https://{{cookiecutter.author_github_handle}}.github.io/cookiecutter-uv/features/publishing/#set-up-for-pypi).
For activating the automatic documentation with MkDocs, see [here](https://{{cookiecutter.author_github_handle}}.github.io/cookiecutter-uv/features/mkdocs/#enabling-the-documentation-on-github).
To enable the code coverage reports, see [here](https://{{cookiecutter.author_github_handle}}.github.io/cookiecutter-uv/features/codecov/).
...
For more details, see [here](https://{{cookiecutter.author_github_handle}}.github.io/cookiecutter-uv/features/cicd/#how-to-trigger-a-release).
{%- endif %}
